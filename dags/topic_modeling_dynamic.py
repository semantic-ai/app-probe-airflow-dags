...
with DAG(
    ...
    command = [
        ...
        "--model_type=topic_model_dynamic"

    ]

    KubernetesPodOperator(
        task_id="topic_modeling_dynamic",
        name="topic_modeling_dynamic",
        image="stadgent/probe-sparql-mono:latest",
        in_cluster=True,
        get_logs=True,
        image_pull_policy="Always",
        startup_timeout_seconds=480,
        container_resources=k8s.V1ResourceRequirements(limits={"cpu": "4", "memory": "12G"},
        ...
        env_vars={
            ...
            "MLFLOW_EXPERIMENT_NAME": "topic_modeling_dynamic",
